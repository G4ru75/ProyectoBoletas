    ...
    <div className="bg-sky-500 p-4 "> 
        ...
        <nav className="px-2 py-2 sm:flex sm:items-center sm:justify-between">
            ...
            <div className="flex flex-col items-start mt-3 gap-2 sm:flex-row smm-0">
                ...
                <button className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-2 rounded-md focus:outline-none focus:shadow-outline transform transition-all hover:scale-105">Registrarse</button>
            </div>
        </nav>
