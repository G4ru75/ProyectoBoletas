        ...
        <div className="bg-sky-500 p-4 "> 
            ...
            <nav className="px-2 py-2 sm:flex sm:items-center sm:justify-between">
                ...
                <div className="flex flex-col items-start mt-3 gap-2 sm:flex-row smm-0">
                    <button className="text-2xl text-gray-700 hover:bg-gray-200 px-2 py-2 rounded">Inicio</button>
                    <button className="text-2xl text-gray-700 hover:bg-gray-200 px-2 py-2 rounded">Información</button>
                    <button className="text-2xl text-gray-700 hover:bg-gray-200 px-2 py-2 rounded">Contacto</button>
